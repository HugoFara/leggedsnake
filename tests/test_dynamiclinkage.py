...
# -*- coding: utf-8 -*-
"""
Tests for the dynamiclinkage module (new hypergraph-based API).
"""
...
from leggedsnake.dynamiclinkage import DynamicLinkage, NodeProxy, convert_to_dynamic_linkage
